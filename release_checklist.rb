...
class ReleaseChecklist < ERB
  ...
  def self.template
    open('https://raw.githubusercontent.com/jhnstn/gbm/main/templates/release_checklist.html.erb').read
  end
  ...
  def initialize(version, options = {})
    ...
    @mobile_version = options.fetch(:mobile_version, "X.XX")
    ...
    @aztec_verified = options.fetch(:aztec_verified, false)
    @scheduled_release = options.fetch(:scheduled_release, true)
